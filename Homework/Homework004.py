...
# set_m = set()
# set_n = set()
# n = int(input("Enter a quantity N: "))
# for i in range(n):
#     number = int(input("Enter a number: "))
#     set_n.add(number)
# m = int(input("Enter a quantity M: "))
# for i in range(m):
#     number = int(input("Enter a number: "))
#     set_m.add(number)
# set_u = set_n.intersection(set_m)
# print(sorted(set_u))
...
n = int(input("Input a quantity of bushes: "))
arr = list()
for i in range(n):
    x = int(input("Input an amount of blueberries: "))
    arr.append(x)
